...
insert into public.games
  (game_id, season, week, game_type, kickoff, home_team, away_team, status)
values
  ('2026_00_KC_DEN',  2026, 0, 'REG', now() + interval '45 minutes', 'DEN', 'KC',  'scheduled'),
  ('2026_00_BUF_PHI', 2026, 0, 'REG', now() + interval '2 hours',    'PHI', 'BUF', 'scheduled'),
  ('2026_00_DAL_GB',  2026, 0, 'REG', now() + interval '5 hours',    'GB',  'DAL', 'scheduled'),
  ('2026_00_MIN_CHI', 2026, 0, 'REG', now() + interval '1 day',      'CHI', 'MIN', 'scheduled'),
  ('2026_00_SF_SEA',  2026, 0, 'REG', now() + interval '2 days',     'SEA', 'SF',  'scheduled'),
  ('2026_00_LAC_LV',  2026, 0, 'REG', now() + interval '3 days',     'LV',  'LAC', 'scheduled')
